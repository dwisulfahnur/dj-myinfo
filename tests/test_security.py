...
import responses
from djmyinfo import settings as myinfo_settings
from jwcrypto import jwk, jws
from myinfo.utils.security import (
    decrypt_jwe,
...
class TestJWT(unittest.TestCase):
    ...
    @patch("myinfo.utils.security.get_random_string")
    @patch("myinfo.utils.security.time.time", return_value=1710202991.123456)
    @patch("myinfo.utils.security.generate_ephemeral_session_keypair")
