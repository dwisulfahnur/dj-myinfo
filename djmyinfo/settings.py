"""
Django settings for djmyinfo project.
...
SECRET_KEY = env('SECRET_KEY', default="3dT0sKf4bQlOrCBPn6ALu869m56kpDTjeFags5FGxLo")
...
WSGI_APPLICATION = 'djmyinfo.wsgi.application'
